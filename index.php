...
<div id="menu" class="container text-center">
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="./index.php?p=home"><img class="logo" src="./img/LogoTipo.png" alt="Logo fabrica de doces" width="150" height="100" ></a>
